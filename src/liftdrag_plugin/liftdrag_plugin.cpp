...
void LiftDragPlugin::OnUpdate()
{
  ...
  else if (this->alpha < -this->alphaStall)
  {
    ...
    cd = this->cd0 +
          (this->cda * (this->alpha - this->alpha0)) +
          (this->cda2 * (this->alpha - this->alpha0) * (this->alpha - this->alpha0));
  ...
  else if (this->alpha < -this->alphaStall)
  {
    ...
    cm = this->cma0 +
          (this->cma * (this->alpha - this->alpha0)) +
          (this->cma2 * (this->alpha - this->alpha0)* (this->alpha - this->alpha0)) +
          (this->cma3 * (this->alpha - this->alpha0)* (this->alpha - this->alpha0)* (this->alpha - this->alpha0)) +
          (this->cma4 * (this->alpha - this->alpha0)* (this->alpha - this->alpha0)* (this->alpha - this->alpha0)* (this->alpha - this->alpha0));
